...
//#include <errno.h>  //don't need this one.
#include <netdb.h>
#include <sys/types.h>
...
//#define "cs5700spring2014" "cs5700spring2014"
...
int calculator(char *buffer)
{
 ...
 //   printf("%i equation is: %s\n", (int)strlen(equation), equation );
    ...
    switch(sign)
    {
        case(43):result = first + second;break;
        case(45):result = first - second;break;
        case(42):result = first * second;break;
        case(47):result = first / second;break;
    }
